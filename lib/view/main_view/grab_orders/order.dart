...
class _OrderCenterState extends State<OrderCenter> {
  ...
  void initState() {
    ...
    //添加监听者
    NotificationCenter.instance.addObserver(NotificationCenter.eventStopGrap, (object){
      if(mounted){
        setState(() {
          cancelTimer();
        });
    ...
    NotificationCenter.instance.addObserver(NotificationCenter.eventStartGrap, (object){
      if(mounted){
        setState(() {
