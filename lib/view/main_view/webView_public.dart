...
class WebViewPublic extends StatefulWidget {
  String urlString;

  WebViewPublic({Key key, this.urlString}) : super(key: key);
  @override
  _WebViewPublicState createState() => _WebViewPublicState();
}

class _WebViewPublicState extends State<WebViewPublic> {
// 标记是否是加载中
  bool loading = true;
  // 标记当前页面是否是我们自定义的回调页面
